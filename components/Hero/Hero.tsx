    ...
    <section className="flex items-center w-full">
                <div className=" relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        <h2 className="text-4xl font-extrabold mx-auto md:text-5xl dark:text-sky-500 text-black">
                          Explore in-demand careers and develop cutting edge skills
                        </h2>
                        <p className="max-w-2xl mx-auto dark:text-zinc-400 text-slate-600">
                        ...
                        <form
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 text-gray-400 bg-gray-700 focus:bg-gray-900 duration-150 outline-none rounded-lg shadow sm:max-w-sm sm:w-auto border border-slate-600"
                            />
