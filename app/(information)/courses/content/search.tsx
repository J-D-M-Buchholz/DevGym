...
import { BiSearchAlt, BiLogoHtml5, BiLogoCss3, BiLogoJavascript, BiLogoAngular, BiLogoReact } from 'react-icons/bi'
    ...
    <div className='realtive overflow-hidden'>
        <div className='max-w-[85rem] mx-auto sm:px-6 lg:px-8 py-10 sm:py-24'>
            <div className='text-center'>
                <h1 className='text-4xl sm:text-6xl font-bold text-gray-800 dark:text-gray-200'>Courses</h1>
                <p className='mt-3 text-gray-600 dark:text-gray-400'>Ditch Theory-Driven Courses and Enter the World of a True Developer</p>
                    ...
                    <form>
                        <div className='relative z-10 flex space-x-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-900 dark:border-gray-700 dark:shadow-gray-900/[.2]'>
                            <div className='w-[32rem]'>
                                <label htmlFor="hs-search-courses-1" className="block text-sm text-gray-700 font-medium dark:text-white"><span className="sr-only">Search courses</span></label>
                                <input type="email" name="hs-search-courses-1" id="hs-search-courses-1" className="p-4 block w-full border-transparent rounded-md focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-900 dark:text-gray-400" placeholder="Search courses" />
                            </div>
                            <div className='flex justify-center items-center'>
                                <a className="p-2 justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" href="#">
